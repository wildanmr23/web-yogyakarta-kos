<?php
    ...
    function tambah_data ($data, $files){
        ...
        $query = "INSERT INTO tb_kos VALUES (null, '$nama', '$no_telpon', '$harga', '$minbayar', '$alamat', '$foto' )";
    ...
    function ubah_data ($data, $files){
        ...
        $query = "UPDATE tb_kos SET nama_pemilik='$nama', no_telpon= '$no_telpon', harga_kos= '$harga', min_bayar='$minbayar', alamat = '$alamat', foto='$foto' WHERE id='$id';";
        $sql = mysqli_query($GLOBALS['conn'], $query);
